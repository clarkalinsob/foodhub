...
import { Button, Card, Dropdown, Icon, Image, Loader, Grid } from 'semantic-ui-react'
              ...
              <Card.Content>
                ...
                {user.role === 'Admin' && editRole ? (
                  <Card.Meta>
                    ...
                    />
                    <Button primary fluid onClick={editUser}>
                      Update Role
                    </Button>
                    {error && (
                  ...
                  <Card.Meta>
                    {role}
                    {'  '}
                    <Icon link name='edit' onClick={() => setEditRole(true)} />
                  </Card.Meta>
                ) : (
